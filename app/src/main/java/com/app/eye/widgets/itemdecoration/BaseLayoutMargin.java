package com.app.eye.widgets.itemdecoration;
...
abstract class BaseLayoutMargin extends RecyclerView.ItemDecoration{
    ...
    void calculateMargin( Rect outRect, int position, int spanCurrent, int itemCount, int orientation, boolean isReverse, boolean isRTL ,int spanSize){
        marginDelegate.calculateMargin( outRect, position, spanCurrent, itemCount, orientation, isReverse, isRTL , spanSize);
    }
